    ...
    <div class="sou">
        ...
        <span class="fr">
            <c:if test="${userSession==null}">
                ...
                <span class="fl">你好，请<a href="/login">登录</a>&nbsp; <a href="/register" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>

            </c:if>
            <c:if test="${userSession!=null}">

                <span class="fl">你好，<a href="/login">${userSession.userName}</a>&nbsp; <a href="/register" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
...
<div class="top">
    ...
    <div class="i_car">
        ...
        <div class="car_bg">
            <!--Begin 购物车未登录 Begin-->
            <div class="un_login">还未登录！<a href="Login.html" style="color:#ff4e00;">马上登录</a> <a href="/detail/bayCar">查看购物车！</a></div>
            <!--End 购物车未登录 End-->
            <!--Begin 购物车已登录 Begin-->
            <ul class="cars">
                <li>
                        ...
                        <li>
                            ...
                            <div class="zj" style="top:-200px;">
                                    ...
                                    <div class="zj_l">
                                        ...
                                        <c:if test="${category.parentId==list.id}">
                                        <div class="zj_l_c">

                                            <h2>${category.name}</h2>

                                            <c:forEach var="category3" items="${categoryList}">
                                                <c:if test="${category3.parentId==category.id}">
...
<div class="i_bg bg_color">
    <div class="i_ban_bg">
        ...
        <div class="inews">
            ...
            <ul>
                <c:forEach var="newsList" items="${newsList}" varStatus="s">
                    <li><span><c:if test="${s.count%2!=0}">[ 特惠 ]</c:if><c:if test="${s.count%2==0}">[ 公告 ]</c:if></span><a href="#">${newsList.title}</a></li>
                </c:forEach>
            </ul>
            <div class="charge_t">
...
<div class="top">
    <div class="logo"><a href="${ctx}/Home?action=index"><img src="${ctx}/statics/${pageContext.request.contextPath}/statics/images/logo.png"></a></div>
    <div class="search">
        <form>
                    ...
                    <li>
                        <div class="img">
                            <a href="javascript:void(0)">
                                <img src="${ctx}/statics/${pageContext.request.contextPath}/statics/images/car1.jpg" width="58" height="58">
                            </a>
                        </div>
                        <div class="name">
